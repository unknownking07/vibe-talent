...
export default function AboutPage() {
  ...
  return (
    <div className="mx-auto max-w-4xl px-4 sm:px-6 py-16">
      ...
      >
        <h2 className="text-xl font-bold text-[var(--foreground)] mb-4">Why VibeTalent Exists</h2>
      ...
      >
        <h2 className="text-xl font-bold text-white mb-6">How the Platform Works</h2>
        <div className="grid sm:grid-cols-2 gap-6">
          {[
            ...
            <div key={item.title} className="flex gap-3">
              ...
              >
                <item.icon weight="fill" size={18} className="text-white" />
              </div>
              <div>
      ...
      >
        <h2 className="text-xl font-bold text-[var(--foreground)] mb-4">Built by Abhinav</h2>
        <div className="space-y-4 text-sm text-[var(--text-secondary)] font-medium leading-relaxed">
          <p>
      ...
      >
        <h2 className="text-xl font-bold text-[var(--foreground)] mb-4">Contact</h2>
        <div className="space-y-3 text-sm text-[var(--text-secondary)] font-medium">
          ...
          <div className="flex flex-col gap-2">
            <p>
              Email:{" "}
              <a href="mailto:vibetalentwork@gmail.com" className="text-[var(--accent)] hover:underline font-semibold">
      ...
      >
        ...
        <h2 className="text-2xl font-bold text-white mb-3">Start Building Your Reputation</h2>
