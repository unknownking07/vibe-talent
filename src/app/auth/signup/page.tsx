      ...
      <div className="mx-auto max-w-md px-4 sm:px-6 py-20">
        ...
        >
          <div
            ...
            style={{ backgroundColor: "#16A34A", border: "2px solid #0F0F0F" }}
          >
            <Check size={28} className="text-white" />
          </div>
          <h2 className="text-2xl font-extrabold uppercase text-[#166534]">Check Your Email</h2>
          <p className="mt-3 text-sm text-[#166534] font-medium">
  ...
  return (
    <div className="mx-auto max-w-md px-4 sm:px-6 py-20">
      <div className="text-center mb-8">
        ...
        <h1 className="text-3xl font-extrabold uppercase text-[#0F0F0F]">Join VibeTalent</h1>
