  ...
  return (
    <div className="mx-auto max-w-md px-4 sm:px-6 py-20">
      ...
      {authErrorCode === "identity_already_exists" && (
        <div
          className="mb-4 p-4 flex items-start gap-3 rounded-2xl"
          style={{
      ...
      >
        <div className="space-y-3">
          <button
            ...
            className="w-full flex items-center justify-center gap-2 px-5 py-4 text-sm font-semibold text-white cursor-pointer transition-colors hover:bg-[var(--accent-hover)] rounded-xl"
            style={{
          ...
          <p className="text-[10px] font-semibold text-center text-[var(--text-muted)] tracking-wide">
            Recommended: auto-verifies your GitHub and syncs your streak
          </p>

          <button
            onClick={() => setConsentProvider("google")}
            className="w-full flex items-center justify-center gap-2 px-5 py-3 text-sm font-semibold text-[var(--foreground)] cursor-pointer transition-colors hover:bg-[var(--bg-surface-light)] rounded-xl"
            style={{
              backgroundColor: "var(--bg-surface)",
              border: "1px solid var(--border-hard)",
            }}
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full flex items-center justify-center px-5 py-3 text-sm font-semibold text-white cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed transition-colors hover:bg-[var(--accent-hover)] rounded-xl"
            style={{
              backgroundColor: "var(--accent)",
              border: "1px solid var(--border-hard)",
            }}
      ...
      <p className="mt-6 text-center text-sm font-medium text-[var(--text-secondary)]">
        ...
        <Link href="/auth/signup" className="font-bold text-[var(--accent)] hover:underline">
          Sign Up
        </Link>
      </p>
