  ...
  return (
    <div className="mx-auto max-w-4xl px-4 sm:px-6 py-16">
      ...
      <div className="flex items-center gap-3 mb-3">
        <Megaphone weight="fill" size={24} style={{ color: "var(--accent)" }} />
        <span
      ...
      >
        <div className="flex items-center gap-3 mb-4">
          <Wallet weight="fill" size={20} style={{ color: "var(--accent)" }} />
      ...
      >
        <div className="flex items-center gap-3 mb-4">
          <Shield weight="fill" size={20} style={{ color: "var(--accent)" }} />
          <h2 className="text-lg font-bold text-[var(--foreground)]">Content Guidelines</h2>
        </div>
        ...
        <h3 className="text-xs font-semibold text-[var(--foreground)] mt-4 mb-2">
          Allowed
        </h3>
        ...
        <h3 className="text-xs font-semibold text-[var(--foreground)] mt-5 mb-2">
          Not Allowed
        </h3>
        <ul className="list-disc pl-6 space-y-1.5 text-sm text-[var(--text-secondary)] font-medium leading-relaxed">
      ...
      >
        <div className="flex items-center gap-3 mb-4">
          <Question weight="fill" size={20} style={{ color: "var(--accent)" }} />
          <h2 className="text-lg font-bold text-[var(--foreground)]">FAQ</h2>
        </div>
        <dl className="space-y-5">
          {faq.map(({ q, a }) => (
            <div key={q}>
              <dt className="text-sm font-semibold text-[var(--foreground)] leading-snug">{q}</dt>
      ...
      <div className="mt-10 flex flex-col sm:flex-row items-center gap-3">
        ...
        <Link
          href="/dashboard"
          className="text-xs font-semibold underline underline-offset-4 text-[var(--text-secondary)] hover:text-[var(--foreground)] transition-colors"
        >
          Manage My Projects →
        </Link>
      </div>
