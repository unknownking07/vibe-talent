    ...
    permissions: [
      {
        ...
        detail: "Your name, username, and avatar",
      },
      {
        icon: <Envelope weight="fill" size={18} />,
        label: "Email address",
        detail: "Your primary email on GitHub",
      },
      {
        icon: <BookOpen weight="fill" size={18} />,
        label: "Public repositories",
        detail: "Read-only access to your public repos",
      },
    ],
    privacyNote:
      "VibeTalent will never push code, create repos, or modify your GitHub account.",
  },
  google: {
    name: "Google",
    icon: (
    ...
    permissions: [
      {
        ...
        detail: "Your display name and avatar",
      },
      {
        icon: <Envelope weight="fill" size={18} />,
        label: "Email address",
        detail: "Your Google email address",
      },
    ],
    privacyNote:
      "VibeTalent will never access your contacts, drive, or any other Google services.",
  },
};
      ...
      >
        ...
        >
          <Shield
            weight="fill"
            size={16}
            className="mt-0.5 text-[#16A34A] shrink-0"
          />
