...
export function EmptySlotCard({ onClaim }: { onClaim: () => void }) {
  return (
    <button
      type="button"
      onClick={onClaim}
      className="relative flex flex-col items-center justify-center gap-3 p-6 md:min-h-[420px] text-left rounded-2xl
    ...
    >
      ...
      <h3 className="text-base font-bold text-[var(--foreground)] text-center">
        Slot Available
      </h3>
