 ...
 */
// eslint-disable-next-line @typescript-eslint/ban-ts-comment -- This module is absent before build and present after it.
// @ts-ignore - generated by `opennextjs-cloudflare build`; absent before build
