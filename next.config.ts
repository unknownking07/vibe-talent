...
const securityHeaders = [
  ...
  },
  {
    ...
    value: [
      ...
      "img-src 'self' data: blob: https://*.supabase.co https://avatars.githubusercontent.com https://lh3.googleusercontent.com https://cdn.jsdelivr.net https://unavatar.io https://www.google-analytics.com https://auth.privy.io https://*.walletconnect.com https://*.walletconnect.org https://www.findalternate.com",
      "font-src 'self'",
